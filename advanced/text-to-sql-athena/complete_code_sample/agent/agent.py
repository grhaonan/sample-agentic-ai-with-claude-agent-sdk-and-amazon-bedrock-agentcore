#!/usr/bin/env python3
"""
Student Analytics AI Agent using Claude Agent SDK.
Handles natural language queries about student management data.
"""
...
async def run_analytics_agent(user_query: str, debug_mode: bool = False):
    """
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog='''
Examples:
  python agent/agent.py "How many students are enrolled?"
  python agent/agent.py "Show me the top 10 students by GPA"
  python agent/agent.py --debug "What's the average GPA by department?"
        '''
    )
    ...
    # Run the agent
    import anyio
    anyio.run(run_analytics_agent, user_query, args.debug)
