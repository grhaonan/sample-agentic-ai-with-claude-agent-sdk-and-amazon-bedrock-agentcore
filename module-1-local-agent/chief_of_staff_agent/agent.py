...
async def send_query(
    ...
    options = ClaudeAgentOptions(
        # NOTE: No `model=` here. This workshop runs on Amazon Bedrock — the model
        # is selected via the ANTHROPIC_MODEL env var (with CLAUDE_CODE_USE_BEDROCK=1),
        # loaded from .env by load_dotenv() above. The SDK inherits it automatically.
        allowed_tools=[
